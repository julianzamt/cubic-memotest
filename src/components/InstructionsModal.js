                ...
                {page === 1 ?
                    ...
                    <div className="page__container">
                        ...
                        <div style={{ textAlign: "center" }}>
                            ...
                            <div className="instructions__text">Found all matches, and win.<br></br>Prepare yourself for the next level. <br></br><span style={{ fontSize: "smaller" }}>(Demo: 1 level only)</span></div>
                        </div>
                        <div style={{ textAlign: "center" }}>
